...
class SpecieMapper:
    ...
    async def specie_to_complete_info_response(self, specie: Specie) -> SpecieResponse:
        family_response = await self.family_mapper.family_to_response(specie.family)
        ...
        return SpecieResponse(
            ...
            family=family_response,
            habitats=habitats_response,
            #identification_date=identification_response
        )
    ...
    async def species_to_complete_info_responses(self, species: list[Specie]) -> list[SpecieResponse]:
        return [
            await self.specie_to_complete_info_response(specie) for specie in species
        ]
