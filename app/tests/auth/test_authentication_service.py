...
@pytest.mark.asyncio
async def test_request_exception_should_be_handled_in_middleware_if_no_token_is_provided(
    client, request_info_with_no_token
):
...
@pytest.mark.asyncio
async def test_request_exception_should_be_handled_correctly_in_middleware_if_invalid_token_is_provided(
    client, request_with_invalid_token
):
    response = client.request(
...
@pytest.mark.asyncio
async def test_user_is_authenticated_after_providing_valid_token(
    client, request_with_valid_token
):
    pass
