    ...
    stages {
        ...
        stage('Deployment') {
            steps {
                ...
                sh 'chmod 755 wildlens_prediction/get_model_file.sh'
                ...
                withCredentials(bindings: [file(credentialsId: 'wildlens_db_env_file', variable: 'db_env_file')]) {
                    script {
                ...
                withCredentials(bindings: [file(credentialsId: 'wildlens_prediction_env_file', variable: 'prediction_env_file')]) {
                    script {
                ...
                withCredentials(bindings: [file(credentialsId: 'wildlens_grafana_env_file', variable: 'grafana_env_file')]) {
                    script {
